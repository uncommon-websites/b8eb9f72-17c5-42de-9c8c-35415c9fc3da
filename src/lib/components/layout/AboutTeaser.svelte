...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Kevin Bhagat",
		role: "Founder & CEO",
		image: "/generated/image-a-professional-portrait-of-a-father-in-a.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"I watched my own family miss too many moments because we were drowning in logistics. I built Rooted so no parent has to choose between career success and being present for what matters."`}
			/>
